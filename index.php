<?php require 'basic/head.php' ;?>
  ...
  <div class="site-wrap">
          ...
          <div class="col-lg-12 align-self-center">
            ...
            <div class="row">
              <div class="col-lg-11">
                ...
                <p>Discovers people who will stay and perform.</p>
              </div>
        ...
        <div class="row">
          <div class="col-12" style="margin-top: -7%;">
            <div class="slide-one-item home-slider owl-carousel">
              <img src="assets/images/coach_hero_1.jpg" alt="Free Website Template by Free-Templat.co" class="img-fluid img">
              <img src="assets/images/coach_hero_2.jpg" alt="Free Website Template by Free-Templat.co" class="img-fluid img">
              <img src="assets/images/coach_hero_3.jpg" alt="Free Website Template by Free-Templat.co" class="img-fluid img">
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="site-section" id="gallery-section">
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="assets/images/coach_1_sm.jpg" data-fancybox="gal"><img src="assets/images/coach_1_sm.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>

            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="assets/images/coach_2_sm.jpg" data-fancybox="gal"><img src="assets/images/coach_2_sm.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
          
            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="assets/images/coach_3_sm.jpg" data-fancybox="gal"><img src="assets/images/coach_3_sm.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
        ...
        <div class="row">
          <div class="col-md-6 mb-4" data-aos="fade-up"  data-aos-delay="">
            <div class="d-lg-flex blog-entry">
              <figure class="mr-4">
                <a href="single.html"><img src="assets/images/coach_1_sm.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid rounded"></a>
              </figure>
    ...
    <footer class="site-footer kp-footer">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
