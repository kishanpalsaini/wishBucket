        ...
        <div class="row">
          <div class="col-12" style="margin-top: -7%;">
            <div class="slide-one-item home-slider owl-carousel head-slider">
              <img src="uploads/gallery/header-1.png" alt="Free Website Template by Free-Templat.co" class="img-fluid img">
              <img src="uploads/gallery/header-2.png" alt="Free Website Template by Free-Templat.co" class="img-fluid img">
              <img src="uploads/gallery/header-3.png" alt="Free Website Template by Free-Templat.co" class="img-fluid img">
              <img src="uploads/gallery/header-4.png" alt="Free Website Template by Free-Templat.co" class="img-fluid img">
              <img src="uploads/gallery/header-5.jpg" alt="Free Website Template by Free-Templat.co" class="img-fluid img">
              <img src="uploads/gallery/header-6.jpg" alt="Free Website Template by Free-Templat.co" class="img-fluid img">
              <img src="uploads/gallery/header-7.png" alt="Free Website Template by Free-Templat.co" class="img-fluid img">
              <img src="uploads/gallery/header-8.png" alt="Free Website Template by Free-Templat.co" class="img-fluid img">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-7 text-center">
            ...
            <p>It is also very pleasant to keep your memories and work done. Come together, make some memories so that these memories keep us close to each other every day. And our captured memories also tell us every day our present is better than our past.</p>
          </div>
        </div>
        
        <div class="row">
          
            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="uploads/gallery/gallery-1.jpg" data-fancybox="gal"><img src="uploads/gallery/gallery-1.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>

            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="uploads/gallery/gallery-2.jpg" data-fancybox="gal"><img src="uploads/gallery/gallery-2.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
          
            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="uploads/gallery/gallery-3.jpg" data-fancybox="gal"><img src="uploads/gallery/gallery-3.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>

            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="uploads/gallery/gallery-4.jpg" data-fancybox="gal"><img src="uploads/gallery/gallery-4.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
          
            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="uploads/gallery/gallery-5.jpg" data-fancybox="gal"><img src="uploads/gallery/gallery-5.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
          
            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="uploads/gallery/gallery-6.jpg" data-fancybox="gal"><img src="uploads/gallery/gallery-6.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
          
            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="uploads/gallery/gallery-7.jpg" data-fancybox="gal"><img src="uploads/gallery/gallery-7.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
          
            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="uploads/gallery/gallery-8.jpg" data-fancybox="gal"><img src="uploads/gallery/gallery-8.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
          
            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="uploads/gallery/gallery-9.jpg" data-fancybox="gal"><img src="uploads/gallery/gallery-9.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
          
            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="uploads/gallery/gallery-10.jpg" data-fancybox="gal"><img src="uploads/gallery/gallery-10.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
          
            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="uploads/gallery/gallery-12.jpg" data-fancybox="gal"><img src="uploads/gallery/gallery-12.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
          
            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="uploads/gallery/gallery-14.jpg" data-fancybox="gal"><img src="uploads/gallery/gallery-14.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
          ...
          <div class="owl-carousel owl-style owl-carousel-one no-owl-nav">
            <div>
              <div class="block-testimony-1 text-center">
                ...
                <blockquote class="mb-4">
                  <p>&ldquo;Make a promise today that you will never make fake promises yourself.&rdquo;</p>
                </blockquote>

                <figure>
                  <img src="uploads/gallery/our-quotes.png" alt="Image" class="img-fluid rounded-circle mx-auto">
                </figure>
            ...
            <div>
              <div class="block-testimony-1 text-center">
                ...
                <blockquote class="mb-4">
                  <p>&ldquo;Always trust yourself, you are the person who has the answers to all your questions.&rdquo;</p>
                </blockquote>
            ...
            <div>
              <div class="block-testimony-1 text-center">
                ...
                <blockquote class="mb-4">
                  <p>&ldquo;Go ahead so much in the race of life that no obstacle will be able to put you back.&rdquo;</p>
                </blockquote>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-4" data-aos="fade-up"  data-aos-delay="100">
            <div class="d-lg-flex blog-entry">
              <figure class="mr-4">
                <a href="single.html"><img src="uploads/gallery/blog-2.png" alt="Free Website Template by Free-Template.co" class="img-fluid rounded"></a>
              </figure>
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          ...
          <div class="mb-4 mb-lg-0 col-md-6 col-lg-4">
            ...
            <p class="mb-0"><a href="#">Wishbucketservices1@gmail.com, manishsaini.you@gmail.com , karanverma12911@gmail.com</a></p>
          </div>
        </div>
        <!-- <div class="row">
